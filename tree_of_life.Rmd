...
output: 
  rmarkdown::html_vignette:
    ...
    css: main.css
vignette: >
  %\VignetteIndexEntry{Visualize tree of life}
...
h = spiral_phylo(tree, log = TRUE, group = cl[ tree$tip.label ], group_col = cate_col)

at1 = c(0, 10, 100, 500, 2043)
at2 = log10(at1 + 1)/h
spiral_yaxis(at = at2, labels = paste0(at1, "mya"), side = "both")

library(ComplexHeatmap)
at = unique(cl[ tree$tip.label ])
at = at[!duplicated(at)]
