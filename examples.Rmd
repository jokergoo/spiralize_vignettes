...
It is also possible to directly use `spiral_phylo()`, however currently it is not possible to
color the branches for `phylo` objects, thus, I manually cut the tree and highlight subtrees by a list
of rectangles. The following code is runnable.
...
l = at %% 100 == 0
spiral_text(at[l] - 0.5, 1, at[l], just = "bottom",
